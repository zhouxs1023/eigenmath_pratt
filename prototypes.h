...
void bignum_scan_integer(const char *s);
void bignum_scan_float(const char *s);
...
// history.cpp
void update_cmd_history(const char *s);
...
// mscan.cpp
unsigned int * mscan(const char *s);
...
void errout(void);
void test(const char *file, const char **s, int n);
...
// symbol.cpp
void std_symbol(const char *s, int n);
U * usr_symbol(const char *s);
